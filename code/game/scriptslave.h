//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/scriptslave.h                                  $
// $Revision:: 8                                                              $
//   $Author:: Steven                                                         $
//     $Date:: 5/10/01 7:24a                                                  $
//
...
//
// $Log:: /red_code/game/scriptslave.h                                       $
// 
// 8     5/10/01 7:24a Steven
// Split moveto into moveto and movetopos to fix conflicting event names.
// 
// 7     5/02/01 9:11a Sketcher
// Fixed the stopspline and continuespline
// 
// 6     5/01/01 6:58p Sketcher
// Adding a Stop and Continue to ScriptSlaves
// 
// 5     4/05/01 2:37p Steven
// Added translation stuff to script_skybox.
// 
...
inline void ScriptSkyOrigin::Archive
	(
	Archiver &arc
	)
   {
