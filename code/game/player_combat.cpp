//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/player_combat.cpp                              $
// $Revision:: 10                                                             $
//   $Author:: Ericf                                                          $
//     $Date:: 5/12/01 1:37p                                                  $
//
...
//
// $Log:: /red_code/game/player_combat.cpp                                   $
// 
// 10    5/12/01 1:37p Ericf
// TOW Rocket Target Idle fix
// 
// 9     26.03.01 11:44a Ericf
...
// 
// 6     26.01.01 1:22p Ericf
// Altered weapon putaway code
// 
...
void Player::PutawayWeapon
   ...
   if ( weapon->isSubclassOf( Weapon ) )
      {
		weapon->targetidleflag = qfalse;
		CancelEventsOfType( EV_Weapon_TargetIdleThink );
      weapon->animate->RandomAnimate( "putaway", EV_Weapon_DonePutaway );
      }
	}
...
/*   if ( weapon && ( water_power >= water_required ) )
      {
      weapon->animate->RandomAnimate( "swipeon", NULL );
      }*/
   }
...
/*   if ( weapon && ( water_power >= water_required ) )
      {
      weapon->animate->RandomAnimate( "swipeoff", NULL );
      }*/
   }
