//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/bspline.cpp                                    $
// $Revision:: 5                                                              $
//   $Author:: Steven                                                         $
//     $Date:: 6/11/01 1:43p                                                  $
//
...
//
// $Log:: /red_code/game/bspline.cpp                                         $
// 
// 5     6/11/01 1:43p Steven
// Added movespline, offsetspline, and turnspline.
// 
// 4     1/23/01 8:53a Steven
// Added spline QUAKED info.
// 
// 3     12/11/00 9:32a Steven
...
CLASS_DECLARATION( Entity, SplinePath, "info_splinepath" )
	{
      ...
      { &EV_SplinePath_SetFadeTime,       SetFadeTime },
		{ &EV_SplinePath_MoveSpline,			MoveSpline },
		{ &EV_SplinePath_OffsetSpline,		OffsetSpline },
		{ &EV_SplinePath_TurnSpline,			TurnSpline },
      { NULL, NULL }
   };
