...
//
// $Log:: /red_code/game/misc.h                                              $
// 
// 7     5/11/01 11:09a Ericf
// Hitching Post Code
// 
// 5     12/11/00 3:18p Steven
// Made str passing const references.
// 
// 4     12/11/00 9:35a Steven
...
class HitchingPost : public Trigger
	{
	public:
		str					hitch_thread;
		qboolean				in_use;

      CLASS_PROTOTYPE( HitchingPost );
...
inline void HitchingPost::Archive
	(
	Archiver &arc
	)
   {
   ...
   arc.ArchiveString( &hitch_thread );
