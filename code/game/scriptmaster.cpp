//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/scriptmaster.cpp                               $
// $Revision:: 6                                                              $
//   $Author:: Sketcher                                                       $
//     $Date:: 6/29/01 9:44a                                                  $
//
...
//
// $Log:: /red_code/game/scriptmaster.cpp                                    $
// 
// 6     6/29/01 9:44a Sketcher
// Began investigating a bug in KillThread()
// 
// 5     6/15/01 3:34p Sketcher
...
CThread *ScriptMaster::CurrentThread
	(
	void
	)
...
CThread *ScriptMaster::CreateThread
   (
	Program *program  
	)
...
CThread *ScriptMaster::GetThread
	(
	int num
	)
