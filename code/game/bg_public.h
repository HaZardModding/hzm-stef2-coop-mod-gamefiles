//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/bg_public.h                                    $
// $Revision:: 25                                                             $
//   $Author:: Ericf                                                          $
//     $Date:: 7/26/01 2:42p                                                  $
//
...
//
// $Log:: /red_code/game/bg_public.h                                         $
// 
// 25    7/26/01 2:42p Ericf
// Crosshair color targeting stuff
// 
// 24    7/23/01 2:37p Sketcher
// First Pass at horse vehicle.  Still needs lots of cleanup
// 
// 23    5/22/01 6:48p Ericf
// Physics work...
// 
// 22    5/21/01 8:18a Sketcher
// Added a SOUNDTYPE_NONE, and fixed a little bit of the sound type stuff, but
// more work needs to be done
// 
// 21    5/02/01 11:36a Ericf
// AG47 Stuff
// 
// 20    5/01/01 1:56p Steven
// Entity fade out stuff.
// 
// 19    4/30/01 2:47p Ericf
// Ladders and AG47 View Code
// 
// 18    4/16/01 11:52a Ericf
// Edit mode code, first update
// 
// 17    3/30/01 1:39p Steven
// Added global terrain option.
// 
// 7     31.01.01 12:38p Ericf
// Changed step size
// 
// 6     1/11/01 2:24p Sketcher
// Initial Work (Data Structure Mostly) for Dynamic Tuning 
// 
// 5     8.01.01 10:43a Ericf
// Changed slope walk angle
// 
// 4     12/20/00 2:43p Steven
// Changed FAKK to Redemption in a bunch of places.
// 
// 3     12/11/00 3:45p Sketcher
// Added BroadcastAlert() and its companion G_BroadcastAlert()
// 
...
//
// 113   10/04/00 6:50p Aldie
// Changed scores
//
// 112   9/20/00 6:58p Aldie
// Another temporary checkin for deathmatch stuff
//
// 111   9/18/00 6:00p Aldie
// Periodic update for FakkArena deathmatch code.
//
// 110   9/12/00 7:03p Aldie
...
#define	GAME_VERSION		"red-base-1"
...
#define  CS_MAX				   (CS_TEAM_INFO+MAX_TEAM_INFO)
...
#define	AG47_MAXS_Z				155
#define	DEFAULT_VIEWHEIGHT	90
#define  AG47_VIEWHEIGHT	   150
...
#define  PMF_ONHORSE				( 1<<16 )   // Riding AG-47
...
#define  EF_LEFT_TARGETED  (1<<4)         // this entity is being targeted by the left hand
#define  EF_RIGHT_TARGETED (1<<5)         // this entity is being targeted by the right hand
...
typedef enum
   ...
   STAT_ARMOR_LEVEL,       // amount of armor the player has
	STAT_GHOSTSHIRT_LEVEL,	// amount of the player's ghost shirt
   ...
   // Deathmatch stuff (advanced 100 from original value to keep it in sync) -Eric
   STAT_ARENA=117,             // Current arena id number the player is in
   STAT_TEAM,              // Current team number
   STAT_QUEUE_PLACE,       // Place in the Queue for Deathmatch
   STAT_KILLS,             // Number of kills
