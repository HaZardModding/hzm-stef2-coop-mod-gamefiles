//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/g_local.h                                      $
// $Revision:: 5                                                              $
//   $Author:: Ericf                                                          $
//     $Date:: 5/22/01 3:11p                                                  $
//
...
#define  EV_REMOVE            -12    // remove any unused entities before spawnargs are parsed
#define  EV_PRIORITY_SPAWNARG -11    // for priority spawn args passed in by the bsp file
