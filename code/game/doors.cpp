//-----------------------------------------------------------------------------
//
//  $Logfile:: /Code/DLLs/game/doors.cpp                                     $
// $Revision:: 19                                                             $
//   $Author:: Ericf                                                          $
//     $Date:: 7/19/02 10:53a                                                 $
//
...
CLASS_DECLARATION( ScriptSlave, Door, "NormalDoor" )
	{
      ...
      { &EV_SetAngle,                  SetDir },
	   ...
	   { &EV_SetGameplayDamage,			setDamage },
		{ &EV_Door_ExtraTriggerSize,	setExtraTriggerSize },
		{ NULL, NULL }
	};
   ...
   if ( !CanBeOpenedBy( other ) )
      ...
      ClassDef		*cls;
		...
		if ( other->isClient() )
         ...
         gi.centerprintf ( other->edict, "$$UnlockItem$$%s", item->getName().c_str() );
			delete item;
			}
      return;
      }
...
CLASS_DECLARATION( Door, ScriptDoor, "script_door" )
	{
		{ &EV_ScriptDoor_SetToggle ,			SetToggle				},
		{ &EV_ScriptDoor_SetTargeted ,			SetTargeted				},
		{ &EV_ScriptDoor_SetOpenPercentage ,	SetOpenPercentage		},
		{ &EV_SetAngle,							SetMoveDir				},
		{ &EV_Door_DoClose,						DoClose					},
		{ &EV_Door_DoOpen,						DoOpen					},
		{ &EV_ScriptDoor_SetupMovement,			SetUpMovement			},
		{ &EV_ScriptDoor_Setup,					SetUpScriptDoor			},
		{ &EV_Use,								ScriptDoorUse			},
		{ &EV_Door_Close,						ScriptDoorClose			},
		{ &EV_Door_Open,						ScriptDoorOpen			},
		{ &EV_ScriptDoor_ForceOpen,				ScriptDoorForceOpen		},
		{ &EV_ScriptDoor_ForceClose,			ScriptDoorForceClose	},
		{ &EV_Door_TriggerFieldTouched,			ScriptDoorFieldTouched	},
		{ &EV_ScriptDoor_GetState,				ScriptDoorGetState		},
		{ NULL, NULL }
	};
