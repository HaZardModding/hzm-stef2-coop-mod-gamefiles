//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/steering.h                                     $
// $Revision:: 4                                                              $
//   $Author:: Sketcher                                                       $
//     $Date:: 7/02/01 2:37p                                                  $
//
...
//
// $Log:: /red_code/game/steering.h                                          $
// 
// 4     7/02/01 2:37p Sketcher
// Modified JumpTo to take in a vertical speed
// 
// 3     4/16/01 11:30a Steven
...
inline void Jump::Archive
   ...
   arc.ArchiveFloat( &speed );
	arc.ArchiveFloat( &vertical_speed );
...
class FollowPath : public Steering
	...
	public:
      CLASS_PROTOTYPE( FollowPath );
		...
		Path						*SetPath( Actor &self, const Vector &from, const Vector &to );
