//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/sentient.h                                     $
// $Revision:: 19                                                             $
//   $Author:: Steven                                                         $
//     $Date:: 5/31/01 9:29a                                                  $
//
...
class Sentient : public Entity
	...
	protected:
      ...
      virtual void      ArmorDamage( Event *ev );
		...
		void			      AddBloodSpurt( const Vector &direction, int bone_number );
	...
	public:
      ...
      void              GiveAmmo( const str &type, int amount, int max_amount=-1 );
      Ammo              *FindAmmoByName( const str &name );
      Item              *giveItem( const str &itemname, int amount = 1 );
      ...
      virtual void      GetStateAnims( Container<const char *> *c );
		void              SpawnEffect( const str &modelname, const Vector &pos );
   };
