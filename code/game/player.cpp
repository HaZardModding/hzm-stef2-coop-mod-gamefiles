...
// 
// 93    7/26/01 2:42p Ericf
// Crosshair color targeting stuff
// 
// 92    7/23/01 2:37p Sketcher
// First Pass at horse vehicle.  Still needs lots of cleanup
// 
// 91    7/20/01 2:18p Ericf
// Movable Crosshair code
// 
// 90    7/18/01 8:04a Sketcher
// Completed first step in Heuristics System re-vamp.
// 
// 89    7/16/01 1:55p Ericf
// Commented out some unused crosshair stuff
// 
// 88    7/03/01 12:27p Ericf
// Changed the way ducking works
// 
// 87    6/27/01 2:30p Ericf
// Reload fixes
// 
// 86    6/25/01 5:26p Ericf
// Grenade Launcher code
// 
// 85    6/08/01 4:47p Ericf
// Added a playerviewangels event, and fixed ducking/standing
// 
// 84    5/29/01 3:13p Ericf
// Can get off the horse from anywhere now, (don't have to be at a hitching
// post)
// 
// 83    5/24/01 10:27a Ericf
// Removed requirement for "dual" at the end of use gun commands
// 
// 82    5/22/01 2:50p Ericf
// Got rid of old viewedit code and replaced it with the new code that uses
// the tool socket
// 
// 81    5/16/01 1:45p Ericf
// Removed some old crouching and auto aim type code
// 
// 80    11.05.01 5:23p Kharward
...
// 
// 79    5/11/01 2:34p Ericf
// More Hitching post code
// 
// 78    5/11/01 11:09a Ericf
// Hitching Post Code
// 
// 77    5/10/01 7:05p Ericf
// Added a trainjump event, to be used in A2E25
// 
// 76    10.05.01 12:01p Kharward
// reset the respawn_time counter after a deathmatch death.
// 
// 75    9.05.01 7:23p Kharward
// Minor changes to support new MultiplayerArena rather than old DM_Arena.
// 
// 74    5/09/01 5:54p Ericf
// Added a IS_IN_MODE conditional for weapons
// 
// 73    5/09/01 5:20p Ericf
// Changed right hand tag
// 
// 72    5/09/01 4:47p Ericf
// More Horse work
// 
// 71    5/09/01 11:49a Ericf
// Horse stuff
// 
// 70    5/08/01 2:40p Ericf
// Fixed some switchmode bugs and some force reload bugs
// 
// 69    5/04/01 2:32p Steven
// Fixed blend stuff not getting reset.
// 
// 68    5/03/01 4:37p Steven
// Worked on water, slime, & lava screen blend stuff.
// 
// 67    5/03/01 2:21p Ericf
// AG47 stuff
// 
// 66    5/02/01 5:00p Ericf
// More AG47 Stuff
// 
// 65    2.05.01 3:43p Kharward
// Updated the edict structure to correctly pass the clientNum.  It is
// initialized to ENTITYNUM_NONE for non-player entities.
// 
// 64    5/02/01 2:05p Steven
// Merged in Strange Company stuff.
// 
// 63    4/30/01 2:47p Ericf
// Ladders and AG47 View Code
// 
// 62    4/23/01 4:34p Ericf
// More viewspawn edit work
// 
// 61    4/20/01 2:58p Ericf
// Changed like... one character.
// 
// 60    4/18/01 3:32p Steven
// Made weapon info a little nicer looking.
// 
// 59    4/18/01 3:29p Ericf
// Another param on FOV
// 
// 58    4/18/01 3:27p Steven
// Added g_showplayerweapon to display some weapon info.
// 
// 57    4/17/01 5:18p Ericf
// Modified editmode to recursively check sub tikis
// 
// 56    4/16/01 11:52a Ericf
// Edit mode code, first update
// 
// 55    4/05/01 11:39a Ericf
// Fixed a "use" bug
// 
// 54    4/04/01 7:40a Steven
// Got rid of some old unused stuff.
// 
// 53    4/02/01 4:31p Sketcher
// setghostshirt can now be called from console
// 
// 52    4/02/01 10:29a Steven
// Added 2 ghost shirt game vars.
// 
// 51    3/28/01 3:25p Steven
// Added warning printfs.
// 
// 50    3/28/01 11:28a Ericf
...
// 
// 48    3/19/01 9:46a Sketcher
// Added Redemption effects, Redemption Health, and Redemptive Scalar
// 
// 47    3/15/01 10:13a Sketcher
// Once Again, I have added armor, and I think this time source will check
// things in correctly
// * 
// * 46    3/15/01 9:54a Sketcher
// * Crossing my fingers for source chafe again
// * 
// * 45    3/15/01 9:43a Sketcher
// * Trying Sourcesafe again
// * 
// * 44    3/15/01 9:35a Sketcher
// * Stupid Source Safe messed up the comments last time, I hope this check in
// * works
// * 
// * 43    3/15/01 9:04a Sketcher
// * Added Standard Armor
// 
// 23    2/07/01 1:23p Sketcher
// Changed the Heuristics System File Layout
// 
// 22    1.02.01 5:43p Ericf
// Fixed Crouch firing
// 
// 21    1/31/01 5:52p Sketcher
// 
// 20    1/31/01 1:57p Sketcher
// Added initialization of heuristics
// 
// 19    31.01.01 12:36p Ericf
// Alittle weapon work
// 
// 18    1/31/01 9:35a Sketcher
// Working on the Heuristics System - Intermediate Check-in
// 
// 17    1/30/01 2:41p Sketcher
// The Heuristics system will now set a skill level value for the level
// 
// 16    30.01.01 9:49a Ericf
// Big code cuts... if anything serious goes wrong, revert back to the code
// before this checkin :)
// 
// 15    26.01.01 1:29p Ericf
// changed move speed and airspeed
// 
// 14    26.01.01 1:21p Ericf
// Weapon code modifcations
// 
// 13    1/23/01 10:37a Sketcher
// Added Code to allow for Saving and Loading of Heuristic File
// 
// 12    1/23/01 8:55a Steven
// Added level vars and game vars back in.
// 
// 11    1/16/01 2:11p Steven
// Script C merge.
// 
// 10    1/11/01 2:24p Sketcher
// Initial Work (Data Structure Mostly) for Dynamic Tuning 
// 
// 9     1/09/01 11:08a Steven
// Increased world size.
// 
// 8     4.01.01 2:25p Ericf
// Changed Hard Impact distance
// 
// 7     12/11/00 3:17p Steven
// Made str passing const references.
// 
// 6     12/11/00 9:33a Steven
// Changed passing of most vectors to const reference.
// 
// 5     12/08/00 9:07a Steven
// Moved bind stuff to a pluggable module.
//
// 406   10/06/00 4:51p Aldie
// Fix for exceeding max inventory
//
// 405   10/04/00 6:50p Aldie
// Changed scores
//
// 404   10/02/00 5:38p Aldie
// Added gibbing to multiplayer stuff
//
// 403   10/02/00 11:55a Aldie
// Added voting
//
// 402   9/28/00 6:51p Aldie
// Added more multiplayer options (voting)
//
// 401   9/26/00 6:58p Aldie
// Another dm update - lots of stuff added
//
// 400   9/20/00 6:58p Aldie
// Another temporary checkin for deathmatch stuff
//
// 399   9/18/00 6:00p Aldie
// Periodic update for FakkArena deathmatch code.
//
// 398   9/12/00 7:03p Aldie
// Complete overhaul of the deathmatch stuff I wrote 2 weeks ago.  More to
// come.  Intermediate checkin
//
// 397   9/11/00 2:58p Aldie
// Changed to contents_body from contents_solid
//
// 396   9/01/00 7:09p Aldie
// More fakk arena work
//
// 395   8/30/00 6:35p Aldie
// More updates for deathmatch
//
// 394   8/30/00 4:35p Aldie
// Added some functionality to get dm working
//
// 393   8/29/00 1:04p Aldie
// Fixed a load statemap problem for multi
//
...
Event EV_Player_SetGhostShirt
   (
	"setghostshirt",
	EV_CHEAT,
	"f",
	"ghostshirt_value",
	"Sets the value of the Ghost Shirt"
	);
Event EV_Player_SetTrainJump
   (
	"trainjump",
	EV_CHEAT,
	"b",
	"bool",
	"Sets the train jump flag for dismounting AG47"
	);
...
CLASS_DECLARATION( Sentient, Player, "player" )
	{
      ...
      { &EV_Player_ActorInfo,                ActorInfo },
		{ &EV_Player_ShowHeuristics,           ShowHeuristics	},
      ...
      { &EV_Player_JoinDMTeam,               Join_DM_Team },
      { &EV_Player_JoinArena,                Join_DM_Arena },
      { &EV_Player_LeaveArena,               Leave_DM_Arena },
      { &EV_Player_CreateTeam,               Create_DM_Team },
      { &EV_Player_LeaveTeam,                Leave_DM_Team },
      { &EV_Player_RefreshArenaUI,           RefreshArenaUI },
      { &EV_Player_Spectator,                Spectator },
      { &EV_Player_CallVote,                 CallVote },
      { &EV_Player_Vote,                     Vote },
      { &EV_Player_DeadBody,                 DeadBody },
		{ &EV_Player_SetAimType,               SetAimType },
		{ &EV_Player_ReloadWeapon,             ReloadWeapon },
		{ &EV_Player_SwitchWeaponMode,			SwitchWeaponMode },
		{ &EV_Player_SetGhostShirt,            SetGhostShirt	},
		{ &EV_Player_SetTrainJump,					TrainJump	},
		{ &EV_Player_ReloadTiki,					ReloadTiki },
		{ &EV_Player_SetViewAngles,				SetViewAnglesEvent },
		{ &EV_Player_ProjDetonate,					ProjDetonate },
		{ &EV_Player_UseEntity,                UseSpecifiedEntity		},

		//Vehicle Event Handoff
		{ &EV_Driver_AnimDone,                  PassEventToVehicle		},
      { NULL, NULL }
	};
...
qboolean Player::checkattackleft
   ...
   if ( ( g_gametype->integer == GT_ARENA ) && !allow_fighting )
      {
      return false;
      }
...
// Checks to see if any weapon is active in the specified hand
qboolean Player::checkweaponhasinvammo
   (
   Conditional &condition
   )
...
qboolean Player::checkweaponreload
	(
	Conditional &condition
	)
	{
...
qboolean Player::checkweaponswitchmode
	(
	Conditional &condition
	)
	{
...
qboolean Player::checkweaponinmode
	(
	Conditional &condition
	)
	{
...
qboolean Player::checkweaponlowered
   (
   Conditional &condition
   )
...
qboolean Player::checkweaponfiretimer
   (
   Conditional &condition
   )
...
qboolean Player::checkweaponfullclip
   (
   Conditional &condition
   )
...
qboolean Player::checkweaponforcereload
   (
   Conditional &condition
   )
	{
...
//   float    hands_fraction;
   Vector   newmins;
	Vector   end( origin + yaw_forward * 80.0f );
  ...
  /* trace = G_Trace( origin, newmins, maxs, end, this, MASK_SOLID, true, "checkladder" );
   ...
   // if our body does not go as far as our hands, we aren't at a ladder
	if ( trace.surfaceFlags & SURF_LADDER )
		...
		{
		if ( trace.fraction == 1.0f )
			gi.DPrintf("Not at ladder, trace complete\n");
		else
			gi.DPrintf("Not at ladder, HIT SOMETHING\n");
		}
...
qboolean Player::CheckLadder
   ...
   trace_t  trace;
   Vector   newmins;
	Vector   end( origin + yaw_forward * 5.0f );
...
qboolean Player::checkcanstand
   ...
   trace = G_Trace( tmporg, newmins, newmaxs, tmporg, this, MASK_PLAYERSOLID, true, "checkcanstand" );
   if ( trace.startsolid )
      {
      return qfalse;
      }
...
//      { "WATER_LEVEL",              checkwaterlevel },
      ...
      { "IS_WEAPON_ACTIVE",                checkweaponactive },
		{ "IS_WEAPON_RELOADING",             checkweaponreload },
		{ "IS_IN_MODE",			             checkweaponinmode },
		{ "IS_WEAPON_SWITCHINGMODE",         checkweaponswitchmode },
      ...
      { "HAS_AMMO",                        checkweaponhasammo },
		{ "HAS_INVAMMO",                     checkweaponhasinvammo },
      { "WEAPONS_HOLSTERED",               checkweaponsholstered },
		{ "WEAPON_LOWERED",						 checkweaponlowered }, // See if we're done with our putaway anim
		{ "WEAPON_FIRETIMER",					 checkweaponfiretimer },
		{ "WEAPON_FORCERELOAD",					 checkweaponforcereload },
		{ "WEAPON_FULLCLIP",						 checkweaponfullclip },
      { NULL,                              NULL },
   };
...
void Player::InitGhostShirt
   (
	void
	)

	{
	GhostShirtValue = 50; //Will Need to get Loaded Value here or get value from heuristics
	MaxGhostShirtValue = 100;
   ...
   // Client killed themself
	if ( attacker == this )
      ...
      if ( dedicated->integer )
         {
         gi.DPrintf( "%s %s\n", client->pers.netname, s1 );
         }
      dmManager.ArenaPrint( this, va( "%s %s\n", client->pers.netname, s1 ) );
      return;
      }
   ...
   if ( attacker && attacker->isClient() )
      ...
      switch( meansofdeath )
         ...
         case MOD_CIRCLEOFPROTECTION:
            s1 = "was electrified by";
            break;
         case MOD_IMPACT:
         case MOD_THROWNOBJECT:
            s1 = "was hit in the head by";
            s2 = "'s object";
            break;
         case MOD_BEAM:
            s1 = "was beamed by";
      ...
      if ( s2 )
         ...
         dmManager.ArenaPrint( this, va( "%s %s %s %s\n", client->pers.netname,
                                                          s1,
                                                          attacker->client->pers.netname,
                                                          s2
                                       )
         ...
         dmManager.ArenaPrint( this, va( "%s %s %s\n", client->pers.netname,
                                                    s1,
                                                    attacker->client->pers.netname
                                       )
                             );
...
void Player::GetOffAG47()
	{
	// Take away the viewmodel item
	takeItem( "ag47_view.tik" );
	
	// We need to spawn an AG47
	Actor *agmodel;
	Vector v, forward, left, up;
	agmodel = new Actor;
	agmodel->setModel( "ag47.tik" );
	agmodel->targetname = "AG47";

	// Position AG47
	angles.AngleVectors( &forward, &left, &up );
	
	// Try getting off to the left
	if ( !trainjump )  
		{
		v = origin + ( left * 80);
		trace_t trace = G_Trace( origin, vec_zero, vec_zero, v, this, MASK_SOLID, true, "Player::GetOffAG47" );
		if ( trace.fraction >= 1.0 )
			{
			agmodel->setOrigin( origin );
			agmodel->setAngles( angles );	
			setOrigin( v );
			}
		else
			{
			// Try getting off to the right
			v = origin + ( left * -80);
			trace_t trace = G_Trace( origin, vec_zero, vec_zero, v, this, MASK_SOLID, true, "Player::GetOffAG47" );
			if ( trace.fraction >= 1.0 )
				{
				...
				{
				// Try getting off from behind
				v = origin + ( forward * -128);
				trace_t trace = G_Trace( origin, vec_zero, vec_zero, v, this, MASK_SOLID, true, "Player::GetOffAG47" );
				if ( trace.fraction >= 1.0 )
					{	
					agmodel->setOrigin( origin );
					...
					{
					// We can't get off at all?
					agmodel->PostEvent(EV_Remove, 0);
					return;
					}
				}
			}
	...
	// Set the CVAR and timer
	gi.cvar_set( "g_onhorse", "0" );
	horsetimedelay = current_ucmd->serverTime + 1000;
	}

void Player::GetOnAG47
	(
	Entity *entity
	)
	{
	gi.cvar_set( "g_onhorse", "1" );
	//giveItem( "ag47_view.tik", 1);
	//SetViewAngles(entity->angles);
   ...
   */
	...
	Vector fpAngles;
	fpAngles = forward.toAngles();

	

	entity->setAngles(fpAngles);
	int tagnum = gi.Tag_NumForName( edict->s.modelindex, "tag_origin" );
	entity->attach(entnum, tagnum);
	
	//entity->PostEvent(EV_Remove, 0);
	horsetimedelay = current_ucmd->serverTime + 1000;
...
void Player::DoUse
   ...
   if ( vehicle )
	...
	// If we're on the horse, we need to get off
	if ( g_onhorse->integer && horsetimedelay <= 0 )
		{
		if ( at_hitchingpost )
			{
			setOrigin(hitch_origin);
			SetViewAngles(hitch_angles);
			setAngles(hitch_angles);
			}
		GetOffAG47();
		return;
		}
   ...
   num = gi.AreaEntities( min, max, touch, MAX_GENTITIES );
	...
	for( i = 0; i < num; i++ )
		...
		if ( hit->entity->targetname == "AG47" && horsetimedelay <= 0 )
			{
			if ( at_hitchingpost && hitch_once )
				continue;

			GetOnAG47(hit->entity);
			}
		else
			{
			event = new Event( EV_Use );
...
pmtype_t Player::GetMovePlayerMoveType
	...
	{
	if ( getMoveType() == MOVETYPE_NOCLIP || spectator )
		{
		return PM_NOCLIP;
		}
	else if ( deadflag )
...
void Player::ClientMove
   ...
   Vector move;
	...
	int moveSpeed = sv_maxspeed->value;
	int noclipSpeed = sv_noclipspeed->value;
	int crouchSpeed = sv_crouchspeed->value;
	int airSpeed = sv_airmaxspeed->value;

   oldorigin = origin;

	if ( g_onhorse->integer )
		{
		moveSpeed = sv_maxspeed->value * 2;
		}

	//gi.DPrintf("Crosshair: %d, %d\n",ucmd->choffset[0], ucmd->choffset[1]);
   ...
   // set move flags
   client->ps.pm_flags &= ~( PMF_FLIGHT | PMF_FROZEN | PMF_NO_PREDICTION | PMF_NO_MOVE | PMF_HAVETARGET | PMF_NO_GRAVITY | PMF_ONHORSE);
	...
	// Get the AG47 view model if we have it
	Item *ag = NULL;
	if ( HasItem("AG47_View"))
		ag = ( Item * )FindItem( "AG47_View" );
	
	// Do stuff if we're on the horse
	if ( g_onhorse->integer )
		{
		client->ps.pm_flags |= PMF_ONHORSE;
		if ( ag )
			{
			client->ps.pm_flags |= PMF_ONHORSE;
			...
			if ( !onAG47 )
				{
				ag->SetOwner(this);
				ag->edict->s.renderfx |= RF_AG47VIEW;
				ag->showModel();
				ag->animate->RandomAnimate("idle");
				onAG47 = qtrue;
				}
			else
				{
				if ( getMoveType() == MOVETYPE_NOCLIP )
					{
					if ( strnicmp(ag->animate->GetName(), "idle", 4 ) )
						ag->animate->RandomAnimate("idle");
					goto OUT;
					}
				...
				if ( ucmd->forwardmove != 0 )
					...
					if ( last_ucmd.buttons & BUTTON_RUN )
						if ( strnicmp(ag->animate->GetName(), "run", 3 ) )
							ag->animate->RandomAnimate("run");

					if ( !(last_ucmd.buttons & BUTTON_RUN) )
						{
						if ( strnicmp(ag->animate->GetName(), "walk", 3 ) )
							ag->animate->RandomAnimate("walk");
						moveSpeed /= 2;
						}
					}
				else
					...
					if ( ucmd->rightmove > 0 )
						{
						if ( strnicmp(ag->animate->GetName(), "strafe_right", 3 ) )
							ag->animate->RandomAnimate("strafe_right");
						moveSpeed /= 3;
						}
					else if ( ucmd->rightmove < 0 )
						{
						if ( strnicmp(ag->animate->GetName(), "strafe_left", 3 ) )
							ag->animate->RandomAnimate("strafe_left");
						moveSpeed /= 3;
						}
					}
	...
	else // Not on the horse
		{
		onAG47 = qfalse;

		if ( ag )
			{
			// Rest anim has no sounds, otherwise we hear sounds eventhough he's invisible
			if ( strnicmp(ag->animate->GetName(), "rest", 4 ) )
				ag->animate->RandomAnimate("rest");
			}
		}
...
OUT:
   ...
   if ( fakePlayer_active )
	...
	if ( !on_ladder )
		{
		// See if we're getting on the ladder
		if ( CheckLadder() && ucmd->forwardmove > 0 )
			on_ladder = qtrue;
		}
	...
	if ( on_ladder )
		...
		trace_t  trace;
		Vector   newmins;
		Vector   end( origin + ladder_dir * 30.0f );
		newmins = mins;
		newmins.z = MAXS_Z - LADDER_HAND_HEIGHT;
		trace = G_Trace( origin, mins, maxs, end, this, MASK_SOLID, true, "checkladder" );
		
		if ( trace.fraction == 1.0f || ucmd->upmove > 0 || (groundentity && ucmd->forwardmove <= 0) )
			{
			on_ladder = qfalse;
			//gi.DPrintf("Getting off ladder.\n");
			}
		else if ( ucmd->forwardmove > 0 )
			{
			// Climbing Up
			ucmd->forwardmove = 0;
			//gi.DPrintf("Climbing Up\n");
			//velocity = vec_zero;
			velocity.z = 150;
			}
		else if ( ucmd->forwardmove < 0 )
...
void Player::ClientThink
   ...
   last_ucmd   = *current_ucmd;
	...
	// Set cvar values
	client->ps.pm_airaccelerate = sv_airaccelerate->value;
	client->ps.pm_wateraccelerate = sv_wateraccelerate->value;
	client->ps.pm_stopspeed = sv_stopspeed->value;
	client->ps.pm_friction = sv_friction->value;
	client->ps.pm_waterfriction = sv_waterfriction->value;
	client->ps.jumpheight = sv_jumpheight->value;
	client->ps.pm_accelerate = sv_accelerate->value;
	
	if ( current_ucmd->serverTime > horsetimedelay )
			horsetimedelay = 0;

	if ( g_onhorse->integer && getMoveType() != MOVETYPE_NOCLIP)
		{
		viewheight = DEFAULT_VIEWHEIGHT + 60;
		}
	else
	...
	if ( level.intermissiontime )
		...
		// can exit intermission after 10 seconds
		if ( ( level.time - level.intermissiontime ) > 10 )
         {
         if ( DM_ACTIVE )
            {
   ...
   if ( !vehicle || !vehicle->Drive( current_ucmd ) )
	...
	if ( weap )
		{
		weap->SetRealViewOrigin(current_ucmd->realvieworigin);
		weap->SetThirdPerson(current_ucmd->thirdperson);
		weap->SetCHOffset( current_ucmd->choffset[0],  current_ucmd->choffset[1]);
		if ( weap->GetTargeted() )
			client->ps.pm_flags |= PMF_HAVETARGET;
		else
			client->ps.pm_flags &= ~PMF_HAVETARGET;
		}
...
void Player::SetPlayerView
   ...
   Camera *camera,
	...
	if ( !g_onhorse->integer )
		...
		client->ps.viewheight = cameraoffset+60;
   ...
   */
   ...
   if ( camera )
      ...
      if ( getMoveType() != MOVETYPE_NOCLIP )
         ...
         client->ps.camera_flags = client->ps.camera_flags & CF_CAMERA_CUT_BIT;
         //client->ps.camera_flags |= CF_CAMERA_ANGLES_ALLOWOFFSET;
         //client->ps.camera_flags |= CF_CAMERA_ANGLES_IGNORE_YAW;
         //client->ps.camera_offset[ YAW ] = 0;
         //client->ps.camera_offset[ PITCH ] = 0;
         }
...
/*   if ( g_crosshair->integer )
      ...
      float scale  = g_crosshair_maxscale->value * length / MAX_WORLD_COORD;
...
void Player::PlayerAngles
   ...
   if ( ( speed > 32 ) && groundentity && ( last_ucmd.forwardmove || last_ucmd.rightmove ) )
      {
      speedscale = 3;
...
void Player::FinishMove
   ...
   // burn from lava, etc
	...
	// Clear out hitching post data.  If we're still in the trigger, it will reset it
	at_hitchingpost = qfalse;
	hitch_angles = vec_zero;
	hitch_origin = vec_zero;
	}
...
*/
      ...
      // Time left
      client->ps.stats[STAT_TIMELEFT_MINUTES] = 0;
      if ( timelimit->integer )
         {
         float time;

         time = ( float )( ( timelimit->integer * 60 ) - ( level.time ) ) / 60.0f;

         client->ps.stats[STAT_TIMELEFT_MINUTES] = (int)time;
         client->ps.stats[STAT_TIMELEFT_SECONDS] = ( time - (int)time ) * 60;
         }
      }
...
/*   if ( water_power >= MINIMUM_WATER_FOR_TURBO && client->ps.stats[STAT_WATER_LEVEL] < MINIMUM_WATER_FOR_TURBO )
   ...
   //client->ps.stats[ STAT_WATER_LEVEL ] = water_power;
	...
	//GhostShirt Stat Update
	client->ps.stats[ STAT_GHOSTSHIRT_LEVEL ] = GhostShirtValue;

	//ArmorValue Stat Update
	client->ps.stats[ STAT_ARMOR_LEVEL ] = ArmorValue;
  ...
  // Weapon *rightweapon = GetActiveWeapon( WEAPON_RIGHT );
   ...
   client->ps.stats[STAT_MAXCLIPAMMO_RIGHT]         = 0;
	client->ps.stats[STAT_POWERUPTIME]					 = poweruptimer;
   ...
   if ( dualweapon )
      ...
      client->ps.activeItems[ITEM_NAME_AMMO_RIGHT]    = AmmoIndex( dualweapon->GetAmmoType( FIRE_MODE2 ) );
		...
		if ( dualweapon->GetClipSize(FIRE_MODE1) > 0 )
			client->ps.activeItems[ITEM_NAME_WEAPON_RIGHT]   = dualweapon->getIndex();
		else
   ...
   if ( poweruptimer > 0 )
   ...
   else
      {
		...
		if ( poweruptype == POWERUP_ACCURACY )
			...
			if ( weap )
				weap->SetAccuracyPowerup( qfalse );
			}
...
void Player::SetGhostShirt
   (
	...
	if ( shirt > MaxGhostShirtValue )
		shirt = MaxGhostShirtValue;

	GhostShirtValue = shirt;

	UpdateGhostShirtVar();
	}

void Player::AdjustGhostShirt
   (
	float adjustment
	)

	{
	GhostShirtValue += adjustment;
	
	if(GhostShirtValue > MaxGhostShirtValue) GhostShirtValue = MaxGhostShirtValue;
	if(GhostShirtValue < 0 ) GhostShirtValue = 0;

	UpdateGhostShirtVar();
	}

void Player::UpdateGhostShirtVar()
	{
	int ghost_shirt_33;
	int ghost_shirt_50;

	ghost_shirt_33 = GhostShirtValue / 33;
	ghost_shirt_50 = GhostShirtValue / 50;

	gameVars.SetVariable( "ghostshirt33", ghost_shirt_33 );
	gameVars.SetVariable( "ghostshirt50", ghost_shirt_50 );
	}

void Player::SetArmorValue
   (
	int armorVal
	)
...
void Player::AdjustArmorValue
   (
	int adjustment
	)

	{
	ArmorValue += adjustment;
...
void Player::AdjustGhostShirt 
   (
	...
	{
	AdjustGhostShirt( ev->GetInteger( 1 ) );
	}
...
void Player::Score
   ...
   if ( g_gametype->integer == GT_ARENA )
      ...
      // Send a message to the client with the scoreboard information
	   for( i = 0 ; i < game.maxclients; i++ )
         ...
         if ( gent->client )
            {
            Player *pl = ( Player * )gent->entity;
            Com_sprintf( entry, sizeof( entry ), "%i %i %i %i %i %i %i",
                                                   gent->client->ps.clientNum,
                                                   pl->num_kills,
                                                   pl->num_deaths,
                                                   pl->num_won_matches,
                                                   pl->num_lost_matches,
      ...
      gi.SendServerCommand( edict-g_entities, "scores %i %s", count, string );
      }
   }


void Player::InitArena
	(
	void
	)
...
void Player::Spectator
   ...
   // Force the player to first person
   gi.SendServerCommand( edict-g_entities, "stufftext \"set cg_3rd_person 0\"" );
...
void Player::Join_DM_Arena
   ...
   {
   ResetScore();
   dmManager.JoinArena( this, ev->GetInteger( 1 ) );
   }

void Player::Leave_DM_Arena
   (
   Event *ev
   )
...
void Player::Create_DM_Team
   ...
   if ( _team )
      {
      gi.centerprintf( this->edict, "You are already on a team" );
      return;
      }
   else
      {
      ResetScore();
      //dmManager.CreateTeam( this );
      }
   }
...
void Player::Leave_DM_Team
   ...
   if ( !_team )
      {
      gi.centerprintf( this->edict, "You are not on a team" );
      return;
      }
   else
      {
...
void Player::Join_DM_Team
   ...
   if ( _team )
      ...
      {
      ResetScore();
//      dmManager.JoinTeam( this, ev->GetInteger( 1 ) );
      }
   }
...
void Player::BeginFight
   (
   void
   )

   {
   // Allow the player to start fighting
...
void Player::InitArenaSpawnPoint
   (
   void
   )
   ...
   // Find a spawnpoint that corresponds to arena number 0
...
void Player::RefreshArenaUI
   ...
   if ( _arena )
      {
      gi.SendServerCommand( edict-g_entities, va( "stufftext \"cg_refresharena_ui %d\"\n", _arena->getID() ) );
      }
   else
      {
      gi.SendServerCommand( edict-g_entities, "stufftext \"cg_refresharena_ui 0\"\n" );
      }
   }
...
void Player::UpdateStatus
   ...
   gi.SendServerCommand( edict-g_entities, status.c_str() );
   }

void Player::HUDPrint
   (
   const char *txt
   )
   ...
   gi.SendServerCommand( edict-g_entities, string.c_str() );
   }
...
void Player::ArmorDamage
   ...
   // Check for teamdamage
   if ( DM_ACTIVE && !g_teamdamage->integer )
      {
      // check to see if the attacker and this player are on the same team
      Sentient *attacker=NULL;

	   attacker = ( Sentient * )ev->GetEntity ( 3 );

      if ( attacker && attacker->isSubclassOf( Player ) )
         {
         Player *p = ( Player * )attacker;

         // Check for team damage immunity
         if ( p->GetMultiplayerTeam() && (p->GetMultiplayerTeam() == this->GetMultiplayerTeam()) )
            {
            return;
            }
         }
   ...
   // Call the regular ArmorDamage()
   Sentient::ArmorDamage( ev );

   // If we're dead, go ahead and gib completely on Projectiles
   if ( ( DM_ACTIVE ) && ( health <= 0 ) && inflictor->isSubclassOf( Projectile ) )
      {
      Gib();
      }
   }
...
void Player::Disconnect
   ...
   if ( g_gametype->integer == GT_ARENA )
      ...
      // If the player has a crosshair, remove that as well
      //if ( crosshair )
      //   {
      //   crosshair->PostEvent( EV_Remove, 0 );
      //   }
      }
   }
...
void Player::CallVote
   ...
   if ( g_gametype->integer == GT_SINGLE_PLAYER )
	...
	if ( !g_allowvote->integer )
      {
		HUDPrint( "Voting not allowed here.\n" );
		return;
	   }
   ...
   if ( level.m_voteTime )
      {
		HUDPrint( "A vote is already in progress.\n" );
		return;
	   }

	if ( votecount >= MAX_VOTE_COUNT )
      {
		HUDPrint( va( "You have called the maximum number of votes (%d).\n", MAX_VOTE_COUNT ) );
		return;
	   }

   str arg1 = ev->GetString( 1 );
   str arg2 = ev->GetString( 2 );

	if( strchr( arg1, ';' ) || strchr( arg2, ';' ) )
      {
		HUDPrint( "Invalid vote string.\n" );
		return;
	   }

	if ( !Q_stricmp( arg1, "restart" ) )
      {}
      ...
      {
		HUDPrint( "Invalid vote string.\n" );
		HUDPrint( "Vote commands are: restart, nextmap, map <mapname>, g_gametype <n> and kick <player>.\n" );
		return;
	   }
   ...
   if ( g_gametype->integer == GT_ARENA )
      {
      dmManager.PrintAllClients( va( "%s called a vote: %s\n", client->pers.netname,
                                                               level.m_voteString.c_str() ) );
      }
   ...
   // Clear all the other players voteflags
   int i,count=0;
...
void Player::Vote
   ...
   str arg1;
	...
	if ( !level.m_voteTime )
      {
		HUDPrint( "No vote in progress.\n" );
		return;
	   }

	if ( voted )
      {
		HUDPrint( "Vote already cast.\n" );
		return;
	   }

   if ( ev->NumArgs() != 1 )
      {
      HUDPrint( "Usage: vote <1|0|y|n>" );
      return;
      }
   ...
   arg1 = ev->GetString( 1 );
	...
	// a majority will be determined in Level::CheckVote
   }
...
void Player::FireWeapon
	...
	if ( p_heuristics )
		p_heuristics->UpdateShotsFired( this );	
	}

void Player::ReleaseFireWeapon
   (
	Event *ev
	)
...
void Player::TrainJump
	(
	Event *ev
	)
	{
	if ( ev->NumArgs() > 0 )
		trainjump = ev->GetBoolean(1);
	else
		trainjump = qtrue;
	}

void Player::SetAtHitchingPost
	(
	qboolean val,
	Vector hangles,
	Vector horigin,
	...
	{
	at_hitchingpost = val;
	hitch_angles = hangles;
	hitch_origin = horigin;
	hitch_once = honce;
	}

qboolean Player::GetAtHitchingPost
	(
	)
	{
	return at_hitchingpost;
	}

qboolean Player::GetCrouch
	(
	)
	{
	if ( last_ucmd.upmove < 0 ) // check for downward movement
...
void Player::ReloadTiki
	...
	strcpy(tmpstr, viewthing->model); // The main model
	sprintf(tikname,"models/%s",ev->GetString(1)); // possibly a sub-tiki

	gi.TikiReload(tikname); // Reload the tiki
	gi.setConfigstring( CS_DEBUGINFO, va( "reload %s %d", tmpstr, gi.modelindex(tikname) ) );

	gi.DPrintf("Reloading Model: %s...\n",tikname);

	// We're going to restart the viewspawn with the updated tiki
	// Remove the old one
	viewthing->PostEvent(EV_Remove, 0);
	
	// Spawn a new one
	Event *ev2 = new Event;
	ev2->AddString(tmpstr);
	Viewmodel.Spawn(ev2);
	viewthing = ( Viewthing * )( ( Entity * )Viewmodel.current_viewthing );

	// Update all its info to be similar to the old one
	if ( ev2 ) delete ev2;
	ev2 = new Event;
...
void Player::SetViewAnglesEvent
	(
	Event *ev
	)
	{
