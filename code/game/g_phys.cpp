//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/g_phys.cpp                                     $
// $Revision:: 8                                                              $
//   $Author:: Sketcher                                                       $
//     $Date:: 8/07/01 8:52a                                                  $
//
...
//
// $Log:: /red_code/game/g_phys.cpp                                          $
// 
// 8     8/07/01 8:52a Sketcher
// More vehicle work
// 
// 7     8/02/01 12:03p Sketcher
// Trying to get vehicles to work better.  Still need to fix prediction
// 
// 6     5/31/01 9:26a Steven
// Made projectiles do a fulltrace instead of normal so they could do area
// damage.
// 
// 5     4/20/01 1:20p Sketcher
// projectiles can now "stick" into walls
// 
// 4     30.01.01 9:46a Ericf
// Removed Rope Code
// 
...
int G_ClipVelocity
	...
	int	blocked;
	float	backoff;
	qboolean hackfuckingbullshit;

	hackfuckingbullshit = false;
...
qboolean G_Push
	(
	Entity  *pusher,
	const Vector &pushermove,
	const Vector &pusheramove
	)
