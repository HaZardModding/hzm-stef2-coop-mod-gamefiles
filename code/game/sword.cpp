//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/sword.cpp                                      $
// $Revision:: 3                                                              $
//   $Author:: Steven                                                         $
//     $Date:: 12/11/00 9:34a                                                 $
//
...
void Sword::SetPowerOff
   ...
   if ( str::icmp( animate->AnimName(), "poweroff" ) )
      animate->RandomAnimate( "poweroff" );
...
void Sword::SetPowerOn
   ...
   if ( str::icmp( animate->AnimName(), "poweron" ) )
      animate->RandomAnimate( "poweron" );
