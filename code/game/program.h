//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/game/program.h                                       $
// $Revision:: 2                                                              $
//     $Date:: 6/18/01 11:10a                                                 $
//
...
public:
	type_t( etype_t t = ev_error, def_t *d = NULL, type_t *n = NULL, type_t *aux = NULL ) :
		type( t ), def( d ), next( n ), aux_type( aux ) { };
...
class Program : public Class
   ...
   public:
      ...
      void           setVector( int offset, Vector &vec );
      void           setString( int offset, const char *text );
      void           setFunction( int offset, func_t func );
      void           setEntity( int offset, Entity *ent );
      void           setTargetList( int offset, TargetList *list );
