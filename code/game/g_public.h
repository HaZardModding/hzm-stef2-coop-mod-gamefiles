...
//
// $Log:: /EF2/game/g_public.h                                               $
// 
// 20    8/29/01 6:07p Steven
// Fixed a bunch of const stuff.
// 
// 19    8/21/01 11:02a Steven
// Making all projects share files properly again.
// 
// 18    7/12/01 2:37p Steven
// Fixed some farplane culling.
// 
// 17    7/02/01 10:12a Steven
// Weather stuff.
// 
// 16    6/26/01 11:00a Sketcher
// Made it so that the anim played during a dialog can be set in the TIKI file
// 
// 15    6/01/01 7:56a Steven
// Added wind stuff.
// 
// 14    5/31/01 9:29a Steven
// Added a get bone parent function.
// 
// 13    5/29/01 1:28p Steven
// Lightmap optimizations and dynamic lightmaps.
// 
// 12    4/24/01 7:33a Steven
// Added dialog text.
// 
// 11    4/16/01 11:52a Ericf
// Edit mode code, first update
// 
// 10    13.04.01 6:51p Kharward
// Added FS_ListFiles to list of FS functions imported.
// 
// 9     3/28/01 3:30p Steven
// Added warning printfs.
// 
// 5     1/30/01 2:15p Steven
// Area based damage stuff.
// 
// 4     1/23/01 10:37a Sketcher
// Added Code to allow for Saving and Loading of Heuristic File
// 
// 3     16.01.01 1:48p Ericf
// added setviewmodel function pointer
// 
...
typedef struct
   ...
   void           (*getUserinfo)( int index, char *buffer, int bufferSize );
	...
	void				(*SetWeatherInfo)( weather_t type, float intensity );
   ...
   // Sound
	...
	char	         *(*GetNextMorphTarget)( const char *name, int *index, int *number_of_amplitudes );
   ...
   void           (*SetSkyPortal)( qboolean skyportal );
	...
	void				(*WidgetPrintf)(char *widgetName, const char *fmt, ...);
