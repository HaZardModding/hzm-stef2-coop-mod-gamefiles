...
#define ArchiveHeader   ( *( int * )"RED" )
#define ArchiveVersion	2                       // This must be changed any time the format changes!
#define ArchiveInfo     "RED Archive Version 2" // This must be changed any time the format changes!
