//-----------------------------------------------------------------------------
//
//  $Logfile:: /red_code/cgame/class.cpp                                      $
// $Revision:: 2                                                              $
//   $Author:: Steven                                                         $
//     $Date:: 3/28/01 2:03p                                                  $
//
...
//
// $Log:: /red_code/cgame/class.cpp                                           $
// 
// 2     3/28/01 2:03p Steven
...
// Changed Allocation routines for game to use the gi.Malloc and gi.Free
